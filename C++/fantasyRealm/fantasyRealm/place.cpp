...
static wstring getName(int i) {
	...
	// research facilities
		...
		if (i >= 175) {						here = names.antarctic[rand() % (sizeof(names.antarctic) / sizeof(names.antarctic[0]))] + L" Laboratory"; }
		else if ((i < 175) && (i >= 150)) {	here = names.antarctic[rand() % (sizeof(names.antarctic) / sizeof(names.antarctic[0]))] + L" Research Facility"; }
		else if ((i < 150) && (i >= 125)) {	here = names.antarctic[rand() % (sizeof(names.antarctic) / sizeof(names.antarctic[0]))] + L" Antarctic Base"; }
		else {								here = names.antarctic[rand() % (sizeof(names.antarctic) / sizeof(names.antarctic[0]))] + L" Antarctic Research Center";	}
	}
	else if ((i < 100) && (i > 0)) {
