...
static map<wstring, int> rareMonsters = { 
	{L"Doppelg\u00E4nger", 0x0001},  {L"Shapeshifter", 0x0001},  {L"Golden Worm", 0x0006}, {L"Pink Slime", 0x000F} , {L"Master Tonberry", 0x000F} };
static map<wstring, int> veryRareMonsters = { 
	{L"Jackelope", 0x000F}, {L"Leprechaun", 0x000F}, {L"Moon Rabbit", 0x000F}, {L"Pepsi Man", 0x000F}, {L"Unicorn", 0x000F}, };
static map<wstring, int> veryLargeAndRareMonsters = { 
	{L"Bigfoot", 0x000F}, {L"Nightwalker", 0x000F}, {L"Phoenix", 0x000F},{L"Thunderbird", 0x000F}, };
